	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="file" class="form-control" id="kaka" name="kaka" required> *file JPG
				</div>
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
		...
		if(move_uploaded_file($_FILES["kaka"]["tmp_name"], $target_dir."/".$nama_baru)){

    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_kk (kaka, no_kk, kepala, desa, rt, rw, kec, kab, prov) VALUES (
            '".$nama_baru."',
			'".$_POST['no_kk']."',
            '".$_POST['kepala']."',
            '".$_POST['desa']."',
