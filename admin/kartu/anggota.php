	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" value="<?php echo $data_cek['desa']; ?>, RT <?php echo $data_cek['rt']; ?> RW <?php echo $data_cek['rw']; ?> (<?php echo $data_cek['kec']; ?> - <?php echo $data_cek['kab']; ?> - <?php echo $data_cek['prov']; ?>)" readonly />
				</div>
			</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							...
							<?php
							$no = 1;
							$sql = $koneksi->query("SELECT p.desa,p.rt,p.rw, p.nik, p.nama, p.jenis_kelamin, a.hubungan, a.id_anggota 
			  from tb_pdd p join tb_anggota a on p.id_pend=a.id_pend where status='Ada' and id_kk=$karkel");
					...
					<hr />
					<img src="file_kaka/<?php echo $data_cek['kaka']; ?>" width="950px" />
				</div>
			</div>
		</div>
