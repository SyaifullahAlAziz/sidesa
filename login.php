...
<body class="hold-transition login-page" style="background-image: url('./dist/img/background.jpg') ;background-repeat:no-repeat;background-size: 100%; ">
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				<center>
					<img src="dist/img/logo.jpg" width=150px />
					<br>
					<br>
					<h5>
